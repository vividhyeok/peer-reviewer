    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="ir-toolbar flex items-center gap-1.5 rounded-2xl px-2 py-1.5 border border-[color:var(--line)] bg-[color:var(--panel)] shadow-xl shadow-black/20 backdrop-blur-xl"
        >
