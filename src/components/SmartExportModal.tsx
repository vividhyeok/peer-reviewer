            ...
            >
                <div className="p-6 border-b border-zinc-100 dark:border-zinc-800 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h3 className="font-bold text-zinc-900 dark:text-zinc-50">Smart Export</h3>
                            <p className="text-xs text-zinc-500">AI-driven document synthesis</p>
                        </div>
                    </div>
                    ...
                    {!result ? (
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <button
                                    ...
                                    className={clsx(
                                        ...
                                        exportType === 'quick-scan' ? "border-blue-500 bg-blue-500/5" : "border-zinc-100 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-600"
                                    )}
                                >
                                    <Zap size={24} className={clsx("mb-3", exportType === 'quick-scan' ? "text-blue-500" : "text-zinc-400")} />
                                    <span className="font-bold text-sm block">Quick Scan</span>
                                    <span className="text-[11px] text-zinc-500 mt-1">General summary for rapid triage.</span>
                                ...
                                <button
                                    ...
                                    className={clsx(
                                        "relative flex flex-col p-4 rounded-2xl border-2 transition-all text-left group",
                                        exportType === 'insight-driven' ? "border-purple-500 bg-purple-500/5" : "border-zinc-100 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-600"
                                    )}
                                >
                                    <Sparkles size={24} className={clsx("mb-3", exportType === 'insight-driven' ? "text-purple-500" : "text-zinc-400")} />
                                    <span className="font-bold text-sm block">Insight Synthesis</span>
                                    <span className="text-[11px] text-zinc-500 mt-1">Personalized based on your notes.</span>
                                    {exportType === 'insight-driven' && <Check size={16} className="absolute top-4 right-4 text-purple-500" />}
                                </button>
                            </div>

                            <div className="bg-zinc-50 dark:bg-white/5 p-4 rounded-2xl border border-zinc-100 dark:border-zinc-800">
                                <div className="flex items-center gap-2 mb-2">
                                    <FileText size={14} className="text-zinc-500" />
                                    <span className="text-[11px] font-bold text-zinc-500 uppercase tracking-widest">Analytics</span>
                                </div>
                                <div className="flex gap-4">
                                    <div className="flex flex-col">
                                        <span className="text-lg font-bold text-zinc-900 dark:text-zinc-100">{paragraphs.length}</span>
                                        <span className="text-[10px] text-zinc-500 uppercase">Paragraphs</span>
                                    </div>
                                    <div className="flex flex-col">
                                        <span className="text-lg font-bold text-zinc-900 dark:text-zinc-100">{annotations.length}</span>
                                        <span className="text-[10px] text-zinc-500 uppercase">Annotations</span>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-4">
                            <div className="max-h-[300px] overflow-y-auto p-4 bg-zinc-50 dark:bg-white/5 rounded-2xl border border-zinc-200 dark:border-zinc-800 font-mono text-[11px] leading-relaxed">
                                <p className="opacity-60 mb-2">--- Preview ---</p>
                                {result}
                            </div>
